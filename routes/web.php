...
Route::middleware('IsLogged')->group(function () {
    ...
    Route::Get('order_list', [AdminPannelController::class, 'OrderList'])->name('OrderList');
    Route::Get('order_list_change_status/{id}', [AdminPannelController::class, 'OrderListChangeStatus'])->name('OrderListChangeStatus');
    Route::Get('seeOrder/{id}', [AdminPannelController::class, 'seeOrder'])->name('seeOrder');
